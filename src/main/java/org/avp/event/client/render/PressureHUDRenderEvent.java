...
public class PressureHUDRenderEvent
{
    ...
    public ModPlayer getProperties()
    {
        return Game.minecraft() != null ? Game.minecraft().thePlayer != null ? ModPlayer.get(Game.minecraft().thePlayer) : null : null;
    }
...
//                            }
    ...
    public void drawImpregnationIndicator(ModPlayer playerProperties)
    {
