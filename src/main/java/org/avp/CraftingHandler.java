...
public class CraftingHandler implements IInitEvent
{
    ...
    public void addRecipes()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(AliensVsPredator.items().mk50pants, 1), "b b", "a a", 'a', AliensVsPredator.items().itemIngotCopper, 'b', AliensVsPredator.blocks().blockIndustrialGlass);
    ...
    public void addSchematics()
    {
        ...
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("turret", Inventories.newStack(blocks.blockTurret, 1), Inventories.newStack(items.itemM41A, 1), Inventories.newStack(items.itemPolycarbonate, 4), Inventories.newStack(items.itemIngotAluminum, 4), Inventories.newStack(items.itemIngotCopper, 4), Inventories.newStack(items.itemLedDisplay, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("redstonefluxGenerator", Inventories.newStack(blocks.redstoneFluxGenerator, 1), Inventories.newStack(blocks.blockTransformer, 4), Inventories.newStack(blocks.blockNegativeTransformer, 4), Inventories.newStack(items.itemPolycarbonate, 4), Inventories.newStack(items.itemIngotAluminum, 4), Inventories.newStack(Items.diamond, 4)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("cryostasisTube", Inventories.newStack(blocks.blockCryostasisTube, 1), Inventories.newStack(items.itemPolycarbonate, 4), Inventories.newStack(items.itemIngotAluminum, 4), Inventories.newStack(blocks.blockIndustrialGlass, 4), Inventories.newStack(blocks.blockLightPanel, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("lightPanel", Inventories.newStack(blocks.blockLightPanel, 1), Inventories.newStack(items.itemPolycarbonate, 2), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(blocks.blockIndustrialGlass, 2), Inventories.newStack(Items.glowstone_dust, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("pulserifle", Inventories.newStack(items.itemM41A, 1), Inventories.newStack(items.itemPolycarbonate, 8), Inventories.newStack(Items.iron_ingot, 8), Inventories.newStack(items.itemIngotAluminum, 6), Inventories.newStack(items.itemIngotCopper, 6), Inventories.newStack(Items.gold_ingot, 4), Inventories.newStack(items.itemIntegratedCircuit, 2), Inventories.newStack(items.itemLedDisplay, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("grenade", Inventories.newStack(items.itemGrenade, 2), Inventories.newStack(Items.iron_ingot, 2), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(Items.gunpowder, 1), Inventories.newStack(items.itemIngotCopper, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("fire_grenade", Inventories.newStack(items.itemIncendiaryGrenade, 2), Inventories.newStack(Items.iron_ingot, 2), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(Items.blaze_powder, 1), Inventories.newStack(items.itemIngotCopper, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("marineHelm", Inventories.newStack(items.helmMarine, 1), Inventories.newStack(Blocks.wool, 3), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemPolycarbonate, 2), Inventories.newStack(items.itemProcessor, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("marinePlate", Inventories.newStack(items.plateMarine, 1), Inventories.newStack(Blocks.wool, 3), Inventories.newStack(items.itemIngotAluminum, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("marineLeggings", Inventories.newStack(items.legsMarine, 1), Inventories.newStack(Blocks.wool, 3), Inventories.newStack(items.itemIngotAluminum, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("marineBoots", Inventories.newStack(items.bootsMarine, 1), Inventories.newStack(Blocks.wool, 1), Inventories.newStack(items.itemIngotAluminum, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("sniperMagazine", Inventories.newStack(items.itemAmmoSniper, 1), Inventories.newStack(items.itemIngotAluminum, 5), Inventories.newStack(Items.gunpowder, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("pistolMagazine", Inventories.newStack(items.itemAmmoPistol, 3), Inventories.newStack(items.itemIngotAluminum, 4), Inventories.newStack(Items.gunpowder, 2), Inventories.newStack(items.itemIngotCopper, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ARAmmo", Inventories.newStack(items.itemAmmoAR, 1), Inventories.newStack(items.itemIngotAluminum, 5), Inventories.newStack(Items.iron_ingot, 1), Inventories.newStack(Items.gunpowder, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ACAmmo", Inventories.newStack(items.itemAmmoAC, 1), Inventories.newStack(items.itemIngotAluminum, 5), Inventories.newStack(Items.gunpowder, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("SMGAmmo", Inventories.newStack(items.itemAmmoSMG, 1), Inventories.newStack(items.itemIngotAluminum, 4), Inventories.newStack(Items.iron_ingot, 4), Inventories.newStack(Items.gunpowder, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("m56sg", Inventories.newStack(items.itemM56SG, 1), Inventories.newStack(items.itemM56SGAimingModule, 1), Inventories.newStack(items.itemM56SGStock, 1), Inventories.newStack(items.itemM56SGBarrel, 1), Inventories.newStack(items.itemM56SGSupportFrame, 1)));
        ...
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("pistol", Inventories.newStack(items.itemPistol, 1), Inventories.newStack(items.itemPistolStock, 1), Inventories.newStack(items.itemPistolBarrel, 1), Inventories.newStack(items.itemPistolAction, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("m4", Inventories.newStack(items.itemM4, 1), Inventories.newStack(items.itemM4Stock, 1), Inventories.newStack(items.itemM4Barrel, 1), Inventories.newStack(items.itemM4Action, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ak47", Inventories.newStack(items.itemAK47, 1), Inventories.newStack(items.itemAK47Action, 1), Inventories.newStack(items.itemAK47Barrel, 1), Inventories.newStack(items.itemAK47Stock, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("doritos", Inventories.newStack(items.itemDoritos, 4), Inventories.newStack(Items.wheat, 4), Inventories.newStack(Items.baked_potato, 4)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("doritosCoolRanch", Inventories.newStack(items.itemDoritosCoolRanch, 4), Inventories.newStack(items.itemDoritos, 4), Inventories.newStack(Items.wheat, 3)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("motionTracker", Inventories.newStack(items.itemMotionTracker, 1), Inventories.newStack(items.itemPolycarbonate, 6), Inventories.newStack(items.itemIngotAluminum, 8), Inventories.newStack(items.itemIngotCopper, 6), Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemProcessor, 2), Inventories.newStack(Items.diamond, 1), Inventories.newStack(Items.iron_ingot, 8)));
        ...
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("nbtDrive", Inventories.newStack(items.itemFlashDrive, 1), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemRAM, 4), Inventories.newStack(items.itemIngotLithium, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticBiomask", Inventories.newStack(items.helmTitanium, 1), Inventories.newStack(items.itemArtifactTech, 2), Inventories.newStack(Items.diamond_helmet, 1), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemPolycarbonate, 2), Inventories.newStack(items.itemProcessor, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticPlate", Inventories.newStack(items.plateTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_chestplate, 1), Inventories.newStack(items.itemIngotAluminum, 3), Inventories.newStack(items.itemPolycarbonate, 3)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticLegs", Inventories.newStack(items.legsTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_leggings, 1), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemPolycarbonate, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticBoots", Inventories.newStack(items.bootsTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_boots, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticAxe", Inventories.newStack(items.axeTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_axe, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticPickaxe", Inventories.newStack(items.pickaxeTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_pickaxe, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticHoe", Inventories.newStack(items.hoeTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_hoe, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticShovel", Inventories.newStack(items.shovelTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_shovel, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticSword", Inventories.newStack(items.swordTitanium, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Items.diamond_sword, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("wristBlade", Inventories.newStack(items.itemWristBlade, 1), Inventories.newStack(items.itemArtifactTech, 2), Inventories.newStack(Items.diamond, 4), Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemPolycarbonate, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("wristbracerBlades", Inventories.newStack(items.itemWristbracerBlades, 1), Inventories.newStack(items.itemArtifactTech, 2), Inventories.newStack(Items.shears, 1), Inventories.newStack(Items.diamond, 2), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemPolycarbonate, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("proximityMine", Inventories.newStack(items.itemProximityMine, 3), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(Blocks.tnt, 2), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticDisc", Inventories.newStack(items.itemDisc, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(Items.diamond, 1), Inventories.newStack(items.itemPolycarbonate, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticShuriken", Inventories.newStack(items.itemShuriken, 2), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemPolycarbonate, 2)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("celticSpear", Inventories.newStack(items.itemSpear, 1), Inventories.newStack(items.itemArtifactTech, 1), Inventories.newStack(items.itemIngotAluminum, 1), Inventories.newStack(items.itemPolycarbonate, 2), Inventories.newStack(Items.diamond, 1)));

        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("polycarbonate", Inventories.newStack(items.itemPolycarbonate, 4), Inventories.newStack(items.itemCarbon, 6), Inventories.newStack(items.itemSilicon, 3)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("carbon", Inventories.newStack(items.itemCarbon, 3), Inventories.newStack(Items.coal, 4)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("resistor", Inventories.newStack(items.itemResistor, 2), Inventories.newStack(items.itemIngotCopper, 2), Inventories.newStack(items.itemCarbon, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("capacitor", Inventories.newStack(items.itemCapacitor, 2), Inventories.newStack(items.itemIngotCopper, 2), Inventories.newStack(items.itemIngotLithium, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("diode", Inventories.newStack(items.itemDiode, 2), Inventories.newStack(items.itemIngotCopper, 1), Inventories.newStack(items.itemCarbon, 1), Inventories.newStack(items.itemSilicon, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("led", Inventories.newStack(items.itemLed, 2), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemDiode, 1), Inventories.newStack(Items.redstone, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("regulator", Inventories.newStack(items.itemVoltageRegulator, 2), Inventories.newStack(items.itemDiode, 1), Inventories.newStack(items.itemIngotCopper, 1), Inventories.newStack(items.itemResistor, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("transistor", Inventories.newStack(items.itemTransistor, 2), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemSilicon, 1), Inventories.newStack(Item.getItemFromBlock(Blocks.lever), 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ic", Inventories.newStack(items.itemIntegratedCircuit, 2), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemIngotCopper, 2), Inventories.newStack(items.itemSilicon, 1), Inventories.newStack(items.itemTransistor, 1), Inventories.newStack(items.itemResistor, 1), Inventories.newStack(items.itemVoltageRegulator, 1), Inventories.newStack(items.itemDiode, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("processor", Inventories.newStack(items.itemProcessor, 1), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemIntegratedCircuit, 5), Inventories.newStack(items.itemIngotLithium, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("motherboard", Inventories.newStack(items.itemMotherboard, 1), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemIntegratedCircuit, 1), Inventories.newStack(items.itemSilicon, 1), Inventories.newStack(items.itemTransistor, 1), Inventories.newStack(items.itemVoltageRegulator, 1), Inventories.newStack(items.itemDiode, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("powerline", Inventories.newStack(blocks.blockPowerline, 4), Inventories.newStack(items.itemPolycarbonate, 4), Inventories.newStack(items.itemIngotCopper, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("powersupply", Inventories.newStack(items.itemPowerSupply, 1), Inventories.newStack(items.itemDiode, 1), Inventories.newStack(items.itemVoltageRegulator, 1), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(blocks.blockTransformer, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ledDisplay", Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemPolycarbonate, 1), Inventories.newStack(items.itemLed, 6), Inventories.newStack(items.itemIntegratedCircuit, 1), Inventories.newStack(items.itemIngotLithium, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("ram", Inventories.newStack(items.itemRAM, 2), Inventories.newStack(items.itemIntegratedCircuit, 3), Inventories.newStack(items.itemVoltageRegulator, 1), Inventories.newStack(items.itemIngotCopper, 2), Inventories.newStack(items.itemSilicon, 2), Inventories.newStack(items.itemPolycarbonate, 1)));
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("solidstatedrive", Inventories.newStack(items.itemSolidStateDrive, 1), Inventories.newStack(items.itemRAM, 2), Inventories.newStack(items.itemVoltageRegulator, 1), Inventories.newStack(items.itemIntegratedCircuit, 1), Inventories.newStack(items.itemIngotLithium, 1), Inventories.newStack(items.itemPolycarbonate, 1)));
    }
}
