...
public class CraftingHandler implements IInitEvent
{
    ...
    public void addSchematics()
    {
        ...
        Assembler.instance.registerSchematic(new AssemblerSchematic("wristBlade", Inventories.newStack(items.itemWristbracer, 1), Inventories.newStack(items.itemArtifactTech, 2), Inventories.newStack(Items.diamond, 4), Inventories.newStack(items.itemLedDisplay, 2), Inventories.newStack(items.itemIngotAluminum, 2), Inventories.newStack(items.itemPolycarbonate, 2)));
