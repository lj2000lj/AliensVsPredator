...
public class SharedPlayer implements IExtendedEntityProperties
{
    ...
    public SharedPlayer(EntityPlayer player)
    {
        super();
        this.thePlayer = player;
    }

    public static final SharedPlayer get(EntityPlayer player)
    {
        return (SharedPlayer) player.getExtendedProperties(IDENTIFIER);
    }
