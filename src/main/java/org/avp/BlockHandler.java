...
public class BlockHandler implements IInitEvent
{
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        Game.register(AliensVsPredator.ID, blockR2PConvertor, "r2pconverter").setCreativeTab(AliensVsPredator.tabMain());
        Game.register(AliensVsPredator.ID, blockP2RConvertor, "p2rconverter").setCreativeTab(AliensVsPredator.tabMain());
