...
public class ItemHandler implements IInitEvent, IPreInitEvent
{
    ...
    public Item                     itemM4                   = (new ItemFirearm(24, 0.5F, 3, 120, (ItemAmmo) itemAmmoAR, Sounds.SOUND_WEAPON_GUNSHOT).setSoundLength(0.75D)).setFull3D();
    ...
    public Item                     itemSniper               = (new ItemFirearm(6, 1.8F, 40, 150, (ItemAmmo) itemAmmoSniper, Sounds.SOUND_WEAPON_SNIPER)).setFull3D();
    ...
    public Item                     itemM41A                 = (new ItemFirearm(99, 0.5F, 2, 120, (ItemAmmo) itemAmmoAC, Sounds.SOUND_WEAPON_PULSERIFLE).setSoundLength(1.25D)).setFull3D();
    ...
    public Item                     itemM56SG                = (new ItemFirearm(128, 0.2F, 2, 120, (ItemAmmo) itemAmmoSMG, Sounds.SOUND_WEAPON_M56SG)).setFull3D();
    ...
    public Item                     itemAK47                 = (new ItemFirearm(32, 0.6F, 3, 110, (ItemAmmo) itemAmmoAR, Sounds.SOUND_WEAPON_GUNSHOT)).setFull3D();
