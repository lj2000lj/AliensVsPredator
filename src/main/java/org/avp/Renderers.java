...
public class Renderers implements IPostInitEvent
{
    ...
    private void registerItemRenderers(ItemHandler items)
    {
        ...
        registerItemRenderer(items.itemSummonerProtomorph, (new RenderItemSummoner(EntityDeacon.class)).setScale(16F).setY(0F));
        ...
        registerItemRenderer(items.itemSummonerSpitter, (new RenderItemSummoner(EntitySpitter.class)).setScale(7.5F).setY(9F));
        ...
        registerItemRenderer(items.itemSummonerOvamorph, (new RenderItemSummoner(EntityOvamorph.class)).setScale(20F).setY(-26F));
        registerItemRenderer(items.itemSummonerChestburster, (new RenderItemSummoner(EntityChestburster.class)).setScale(9F).setY(1F));
        registerItemRenderer(items.itemSummonerFacehugger, (new RenderItemSummoner(EntityFacehugger.class)).setScale(15F).setY(-18F));
        registerItemRenderer(items.itemSummonerRoyalFacehugger, (new RenderItemSummoner(EntityRoyalFacehugger.class)).setScale(15F).setY(-16F));
        registerItemRenderer(items.itemSummonerMarine, (new RenderItemSummoner(EntityMarine.class)).setScale(16F).setY(-12F));
        registerItemRenderer(items.itemSummonerYautja, (new RenderItemSummoner(EntityYautja.class)).setScale(7.5F).setY(8F));
        registerItemRenderer(items.itemSummonerPredalien, (new RenderItemSummoner(EntityPredalien.class)).setScale(8F).setY(6F));
        registerItemRenderer(items.itemSummonerAqua, (new RenderItemSummoner(EntityAqua.class)).setScale(7.5F).setY(8F));
        registerItemRenderer(items.itemSummonerCombatSynthetic, (new RenderItemSummoner(EntityCombatSynthetic.class)).setScale(16F).setY(-12F));
        registerItemRenderer(items.itemSummonerHammerpede, (new RenderItemSummoner(EntityHammerpede.class)).setScale(10.5F).setY(-4F));
        registerItemRenderer(items.itemSummonerTrilobite, (new RenderItemSummoner(EntityTrilobite.class)).setScale(8F).setY(4F));
        registerItemRenderer(items.itemSummonerSpaceJockey, (new RenderItemSummoner(EntitySpaceJockey.class)).setScale(10F).setY(0F));
        registerItemRenderer(items.itemSummonerEngineer, (new RenderItemSummoner(EntityEngineer.class)).setScale(10F).setY(0F));
