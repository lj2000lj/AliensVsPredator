...
public class Sounds implements IPostInitEvent
{
    ...
    public static Sound        SOUND_WEAPON_PLASMACASTER_CHARGE   = new Sound(AliensVsPredator.properties().DOMAIN + "weapon.plasmacaster.charge");
    public static Sound        SOUND_WEAPON_PLASMACASTER_NOENERGY = new Sound(AliensVsPredator.properties().DOMAIN + "weapon.plasmacaster.noenergy");
    public static Sound        SOUND_WEAPON_PLASMA_EXPLOSION      = new Sound(AliensVsPredator.properties().DOMAIN + "weapon.plasmacaster.explosion");
